...
#### _**Ambos proyectos fueron desplegados en Vercel.**_

## Tecnologias en total usadas, contando todos los proyectos
...
![imagen de Google Analytics en satelliteQuiz](./campaign/satellitequiz-GA.jpg)

### Interacciones totales en nuestra cuenta de Instagram
![imagen de interacciones totales en nuestra cuenta de instagram](./campaign/ig-interactions.jpg)

### Visualizaciones + porcentaje de usuarios que eran seguidores y no eran seguidores
![imagen de las visualizaciones + porcentaje de usuarios que eran seguidores y no eran seguidores](./campaign/ig-visualizations.jpg)